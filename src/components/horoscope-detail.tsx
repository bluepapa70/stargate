...
const zodiacIconPaths: Record<ZodiacKey, string> = {
  aries:
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div className="max-w-3xl">
              ...
              <div className="mt-6 flex items-center gap-4">
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-accent-soft shadow-[0_12px_24px_rgba(120,60,200,0.2)]">
                  <svg viewBox="0 0 24 24" className="h-8 w-8 fill-accent-strong" aria-hidden="true">
